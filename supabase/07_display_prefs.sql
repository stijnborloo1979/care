...
comment on column public.household.display_prefs is
  'scale (1 | 1.15 | 1.3 | 1.5), contrast (normal | high), theme (auto | light | dark), accent (groenblauw | blauw | groen | paars | warm), autoOpnemen (0 | 5 | 10 | 20 | 45 sec), simple (bool), voice (bool), licht (bool), schermAan (bool), kiosk (bool), kioskTerug (2 | 5 | 10), nachtVan, nachtTot (uur 0-23).';
